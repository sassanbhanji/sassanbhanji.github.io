...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "projects-constitutional-ai",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-camhacks-25-project",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/Sassan_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%62%32%37%30%30@%63%61%6D.%61%63.%75%6B", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/sassan-b-92b772215", "_blank");
        },
      },{
      id: 'light-theme',
